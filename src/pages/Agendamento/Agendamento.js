...
function Agendamento() {
  ...
  useEffect(() => {
    if (filtro === "cardiologia") {
      setshowCardiologia(true);
    } else {
      setshowCardiologia(false);
    }
    if (filtro === "neurologia") {
      setshowNeurologia(true);
    } else {
      setshowNeurologia(false);
    }
    if (filtro === "pneumologia") {
      setshowPneumologia(true);
    } else {
      setshowPneumologia(false);
    }
    if (filtro === "selecione") {
      setShowTodos(true);
    } else {
            ...
            <div className="filtroprofissionais">
              ...
              {showTodos && (
                <div>
                  ...
                  >
                    <option value="selecione">Selecione o profissional</option>
                    <option value="b1ec2eb0-7f2f-4f71-b0c1-ffef54341b43">
                      Mary Jane
                    </option>
                    <option value="Carolaine Santos">Carolaine Santos</option>
                    <option value="Ivete Sangalo">Ivete Sangalo</option>
